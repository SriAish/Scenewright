...
/*
  Entity type/data zod schemas, shared across campaign-scoped and
  library-scoped entity routes (moved out of the campaign entities
  route's _shared.ts, step 14, so /api/library/entities can reuse the
  exact same shapes instead of duplicating them).
*/
